        ...
        <div>
          {selectedOption.salePrice ? (
            <div className="flex text-2xl items-center gap-x-1 text-green-600">
              ৳ {selectedOption.salePrice}
              <div className="flex text-xl items-center gap-x-0.5 text-[#ef4444] line-through">
          ...
          <>
            <div className="absolute left-0 top-4 z-10">
              {selectedOption?.freeShipping && (
                <h3 className="px-3 bg-[#10b1df] text-white py-1 shadow-xl">
                  Free Shipping
                </h3>
              )}
            </div>
            ...
            {selectedOption?.discountValue > 0 && (
              <div className="absolute right-0 top-4 z-10">
                <h3 className="px-3 bg-[#ef4444] text-white py-1 shadow-xl">
                  ...
                  <div className="w-full ">
                    ...
                    <div className="mt-6 flex gap-4">
                      <button
                        ...
                        className="px-4 py-2 rounded flex items-center gap-2 bg-[#FC8D0B] duration-200 hover:text-white"
                      >
                    ...
                    <li className="mt-8 flex flex-wrap lg:block  bg-white xl:px-3 shadow rounded">
                      {serviceList.map((item, index) => {
                        ...
                        return (
                          ...
                          >
                            <h2 className="text-5xl text-[#FC8D0B]">
                              <Icon />
                            </h2>
                            <div>
