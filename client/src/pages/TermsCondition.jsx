      ...
      <div className="font-inter mb-20">
        <Containar>
          <div className="max-w-5xl mx-auto p-6">
            <p className="mb-4">
              Welcome to Pacific Bath ! Before you start shopping, please take a
            ...
            <p className="mb-4">
              By accessing or using the Pacific Bath website, you agree to comply
            ...
            <p className="mb-4">
              All content on the Pacific Bath website, including text, graphics,
            ...
            <p className="mb-4">
              Pacific Bath is not liable for any indirect, incidental, or
            ...
            <p className="mb-4">
              ...
              <a href="mailto:tuhincrpkhan@gmail.com" className="text-blue-500">
