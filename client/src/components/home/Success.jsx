...
const Success = () => {
  ...
  return (
    <div className="font-robo relative">
      ...
      <Containar>
        <div className="mb-24 pt-8 lg:pt-16 lg:pb-10">
          <div className="my-10 text-center">
            ...
            <h2 className="text-[20px] sm:text-[36px] max-w-3xl mx-auto font-semibold">
              From Fields to Fortune: Empowering Farmer Success Stories
            </h2>
          </div>
                    ...
                    {stories?.doc?.map((storie) => (
                      <SwiperSlide key={storie?._id}>
                        <div className="flex flex-wrap-reverse cursor-pointer w-full items-center justify-between px-0 pt-10">
                          <div
                            onClick={() =>
                              navigate(`/success-stories/${storie?._id}`)
                            }
                            className="bg-[#F2F2F2] w-full sm:w-[49%] rounded-lg p-10 h-[220px] sm:h-[380px] relative bg-red-300="
                          >
