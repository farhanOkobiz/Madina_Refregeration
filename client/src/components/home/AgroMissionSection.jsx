        ...
        <div className="py-[95px] w-full">
          <div className="flex flex-col md:flex-row gap-y-10 md:gap-y-0 justify-between items-start w-full pb-10 md:pb-20 lg:pb-48">
            <div className="z-20 w-full md:w-3/5">
              <h6 className="text-primary font-bold text-xl mb-3 uppercase text-center md:text-left md:ml-3 lg:ml-0">
                Our Mission
              </h6>
          ...
          <div className="relative hidden xl:inline-block w-full">
          ...
          {/* for small device */}
          <div className="relative w-full xl:hidden lg:mt-28">
            <img
              src={bgImg2}
              alt=""
