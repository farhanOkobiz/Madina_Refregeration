  ...
  return (
    <div ref={searchRef} className="relative lg:inline-block hidden">
      <input
        ...
        // className="px-4 py-2 outline-none w-full text-sm text-gray-600 "
      ...
      <button className="bg-primary hover:bg-white text-white hover:text-primary border-primary border-2 px-4 py-2 absolute right-3 rounded top-1/2 -translate-y-1/2 uppercase text-sm transition-all ease-linear duration-200">
