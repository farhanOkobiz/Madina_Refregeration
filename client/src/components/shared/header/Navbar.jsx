...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="font-inter h-screen overflow-scroll ">
          <div className="py-4 px-7 flex justify-between items-center bg-gray-200">
            <Link className="flex items-baseline" to="/">
              <div className="mb-2 mt-3  flex gap-2 items-center">
          ...
          <div className="border-t border-t-border ">
            ...
            <ul className=" flex  flex-col min-h-[600px] relative overflow-y-auto overflow-x-hidden">
      ...
      <nav className="mx-auto font-inter shadow-sm bg-gray-200 lg:bg-white px-5 lg:px-5 xl:px-0">
        {/* Main Navigation */}
          ...
          <Containar>
            <div className="mx-auto lg:h-24 xl:h-28">
              <div className="flex flex-wrap justify-between items-center">
                ...
                <div className="flex items-center gap-28 lg:gap-24">
                  <Link to="/" className="flex items-center">
                    <div className="py-1 md:py-2 flex items-center">
                      <img
                        src={logo}
                        alt="Logo"
                        className="w-36 md:w-16 xl:w-32 object-contain rounded-md"
                      />
                    </div>
                  </Link>
                  ...
                  <div className="flex flex-wrap items-center border">
                    <div
                      onClick={toggleDrawer}
                      className="group flex items-center gap-x-2  px-2 xl:px-5 py-1 xl:py-2 rounded cursor-pointer border-r"
                    >
                ...
                {/* <div
                  onClick={toggleDrawer}
                  className="group flex items-center gap-x-2 border border-[#6d9157] px-2 xl:px-5 py-1 xl:py-2 rounded cursor-pointer"
                >
                  <HiOutlineMenuAlt1 className="text-xl lg:text-3xl group-hover:scale-110 duration-200" />
                  <span className="text-sm lg:text-base">Categories</span>
                </div> */}

                {/* <ul className="hidden sm:flex items-center gap-x-5 xl:gap-x-10 ">
                  {menusList.map((item, index) => (
                    <li key={index}>
                      <NavLink
                        to={item.link}
                        className={({ isActive }) =>
                          isActive
                            ? "text-danger font-medium text-base leading-[90px] underline"
                            : "font-medium text-base leading-[85px] hover:text-[#6d9157] duration-200"
                        }
                      >
                        {item.name}
                      </NavLink>
                ...
                <div className="hidden md:flex items-center space-x-4 text-gray-600">
                  <div className="flex gap-2 xl:gap-5 items-center border-r px-2 xl:px-5">
                    <div>
                      ...
                      <a href="tel:+8801794042193">01794042193</a>
                    </div>
                    <div className="bg-[#eaeaec] hover:bg-primary text-2xl hover:text-white w-10 h-10 rounded-full flex items-center justify-center transition duration-300">
                      <a href="tel:+8801794042193">
                        <IoCallOutline />
                      </a>
                    </div>
                  </div>
                  ...
                  <Link
                    to={"/checkout"}
                    className="flex items-center hover:text-[#6d9157] duration-200 group"
                  >
            ...
            <div className="w-full lg:w-[96%] xl:w-full hidden absolute z-10 left-1/2 transform -translate-x-1/2 -translate-y-1/2 lg:flex items-center justify-between bg-black text-white">
              <ul className="hidden sm:flex items-center gap-x-5 xl:gap-x-10 uppercase px-5 py-3 mx-auto ">
                {menusList.map((item, index) => (
                  <li key={index}>
                    <NavLink
                      to={item.link}
                      className={({ isActive }) =>
                        isActive
                          ? "text-[#FC8D0B] font-medium text-sm"
                          : "font-medium text-sm  hover:text-[#FC8D0B] duration-200"
                      }
                    >
                      {item.name}
                    </NavLink>
              ...
              {/* <Link to="/shop" className="bg-[#E53E3E] px-5 py-3 rounded-r">
                Discount Now{" "}
                <span className="bg-white text-[#E53E3E] px-5 py-1 rounded-full">
                  Sale
                </span>
              </Link> */}
            </div>
