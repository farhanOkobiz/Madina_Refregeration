                          ...
                          {item?.selectedColor ? (
                            <div className="text-sm mt-3 font-normal capitalize flex items-center gap-x-3">
                              ...
                              <div className="flex items-center gap-x-0.5">
                                ...
                                <div className="px-1 py-0.5 rounded-sm text-sm text-texthead ">
                                  {" "}
          ...
          <Containar>
            <div className="mx-auto">
              <div className="flex flex-wrap justify-between items-center">
                ...
                <div
                  onClick={toggleDrawer}
                  className="group flex items-center gap-x-2 border-primary border px-2 lg:px-5 py-2 rounded cursor-pointer"
                >
                  ...
                  {menusList.map((item, index) => (
                    <li key={index}>
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          isActive
                            ? "text-primary font-medium text-base leading-[90px]"
                            : "font-medium text-base leading-[85px] hover:text-primary duration-200"
                        }
                      >
                        {item.name}
                      </NavLink>
                ...
                <div className="flex items-center space-x-4 text-gray-600">
                  ...
                  <Link
                    to={"/checkout"}
                    className="flex items-center hover:text-[#e53e3e] duration-200 group"
                  >
