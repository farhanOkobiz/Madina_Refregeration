  ...
  return (
    <>
      <motion.div className="max-w-xs border border-gray-300 rounded overflow-hidden shadow-lg mx-1 ">
        {totalStock > 0 ? (
          <Link to={`/productdetail/${product?.slug}/${id}`}>
        ...
        <div className="lg:px-4 pt-2 text-center">
        ...
        <div className="flex justify-around border-t border-gray-200 relative">
          ...
          <div
            ...
            className={`relative group duration-200 ${
              totalStock > 0
                ? "cursor-pointer hover:bg-[#FC8F10] text-gray-500 hover:text-white"
          ...
          {totalStock > 0 ? (
            <Link
              to={`/productdetail/${product?.slug}/${id}`}
              className="border-r border-l relative group duration-200 cursor-pointer hover:bg-[#FC8F10] text-gray-500 hover:text-white w-1/2 flex justify-center py-3"
            >
